 <form action="" method="POST">
     ...
     <div class="row">
         <div class="col-xs-12">
             <h2 class="page-header">
                 <i class="fa fa-globe"></i>Madridejos Community College
     ...
     <div class="row invoice-info">
        ...
        foreach ($cur as $result) {
            $course_val = $result->COURSE_NAME.'-'.$result->COURSE_LEVEL;
          echo '<option '. (isset($_POST['Course']) && $_POST['Course']==$course_val? 'selected="selected"' : '') .' value="'.$course_val.'" >'.$result->COURSE_NAME.'-'.$result->COURSE_LEVEL.' </option>';
      ...
      ?>
         ...
         <div class="col-sm-2 invoice-col">
             ...
             <address>
                 <select name="Semester" class="form-control">
                     <option
                         <?php if(isset($_POST['Semester']) && $_POST['Semester']=='First') { echo 'selected="selected"'; } ?>
                         value="First">
                         First</option>
                     <option
                         <?php if(isset($_POST['Semester']) && $_POST['Semester']=='Second    ') { echo 'selected="selected"'; } ?>
                         value="Second">
                         Second</option>
                 </select>
             </address>
        ...
        foreach ($cur as $result) {
          echo '<option '.(isset($_POST['SY']) && $_POST['SY']==$result->AY ? 'selected="selected"' : '').'>'.$result->AY.'</option>';
         ...
         <div class="col-xs-12 col-md-12 table-responsive">
             <table class="table table-bordered table-striped" style="font-size:11px" cellspacing="0">
                 ...
                 <tbody>
                     <?php
                $tot = 0;
               if(isset($_POST['Course']) && isset($_POST['Semester']) && isset($_POST['SY'])){ 
