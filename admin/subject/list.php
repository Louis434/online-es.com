...
<div class="row">
      <div class="col-lg-12">
        	...
        	<!-- /.col-lg-12 -->
			 ...
			 <form style="margin-bottom: 2rem" action="controller.php?action=import" method="POST" name="uploadCsv" enctype="multipart/form-data">
			 	<div class="input-group">
			 		<input type="file" name="file" accept=".csv" class="form-control" aria-describedby="import" />
			 		<span class="input-group-addon" id="import">
