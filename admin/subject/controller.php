...
switch ($action) {
	...
	function doInsert(){
		...
		if ($_POST['SUBJ_CODE'] == "" OR $_POST['SUBJ_DESCRIPTION'] == "" OR $_POST['UNIT'] == "" OR $_POST['COURSE_ID'] == "none"  OR $_POST['SEMESTER'] == "" ) {
			$messageStats = false;
			...
			$subj->create();
						...
						// $autonum = New Autonumber();  `SUBJ_ID`, `SUBJ_CODE`, `SUBJ_DESCRIPTION`, `UNIT`, `COURSE_ID`, `AY`, `SEMESTER`
